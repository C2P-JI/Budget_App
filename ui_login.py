...
def credential_check_service(username, password, root):
...
class UIlogin:
    ...
    def open_login_window(self):
        ...
        login_button = tk.Button(login_window, text="Login", command=lambda: credential_check_service(username_entry.get(), password_entry.get(), self.master))
